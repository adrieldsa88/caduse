package com.adrieldsa88.caduse.infrastructure.security;
...
public class JwtUtil {
    ...
    private final String secretKey = "xhHeh+mdfLqe1XG2MyA9oMze+4/yrzLh58p61nvTORM=";
    ...
    public String generateToken(String username) {
        ...
        // Cria a SecretKey a partir dos bytes
    ...
    public Claims extractClaims(String token) {
        ...
        return Jwts.parser()
                .verifyWith(key)                    // em vez de setSigningKey
                .build()
                .parseSignedClaims(token)           // em vez de parseClaimsJws
                .getPayload();                      // em vez de getBody
    }
